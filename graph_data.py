...
graph_data = [
    ...
    # New Graph 1 (10 Nodes)
    [
        [(0, 0), [1]],                      # Node 0 (start)
        [(100, 100), [0, 2, 4]],           # Node 1
        [(200, 0), [1, 3]],                # Node 2
        [(300, 100), [2, 5]],              # Node 3
        [(100, 200), [1, 6]],              # Node 4
        [(200, 200), [3, 7, 8]],           # Node 5
        [(100, 300), [4, 9]],              # Node 6
        [(300, 200), [5]],                  # Node 7
        [(200, 300), [5]],                  # Node 8
        [(0, 400), [6]]                    # Node 9 (exit)
    ...
    [
        ...
        [(300, 200), [5, 9]],              # Node 7
        [(300, 300), [6]],                  # Node 8
        [(400, 200), [7]]                   # Node 9 (exit)
    ],
    # New Graph 3 (25 Nodes)
    [
        [(0, 0), [1, 5]],                     # Node 0 (start)
        [(100, 0), [0, 2]],                   # Node 1
        [(100, 100), [1, 3]],                 # Node 2
        [(100, 200), [2, 4]],                 # Node 3
        [(200, 200), [3, 5]],                 # Node 4
        ...
        [(300, 200), [7, 9]],                 # Node 8
        [(400, 200), [8, 10]],                # Node 9
        [(400, 100), [9, 11]],                # Node 10
        [(400, 0), [10, 12]],                 # Node 11
        [(500, 0), [11, 13]],                 # Node 12
        [(500, 100), [12, 14]],               # Node 13
        [(500, 200), [13, 15]],               # Node 14
        [(600, 200), [14, 16]],               # Node 15
        [(600, 100), [15, 17]],               # Node 16
        [(600, 0), [16, 18]],                 # Node 17
        [(700, 0), [17, 19]],                 # Node 18
        [(700, 100), [18, 20]],               # Node 19
        [(700, 200), [19, 21]],               # Node 20
        [(800, 200), [20, 22]],               # Node 21
        [(800, 100), [21, 23]],               # Node 22
        [(800, 0), [22, 24]],                 # Node 23
        [(900, 0), [23]]                       # Node 24 (exit)
    ]
]
...
test_path = [
    ...
    [1, 2, 5, 8, 9, 10],
    [1, 14, 5, 6, 9, 15],
    # New Test Paths for Graph 1 (10 nodes)
    [1, 4, 6, 9],
    # New Test Path for Graph 2 (10 nodes)
    [1, 3, 5, 7, 9],
    # New Test Path for Graph (25 nodes)
